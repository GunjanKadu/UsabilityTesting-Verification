                ...
                <div key={item.id} className="my-1">
                    <div className="card border-danger ">
                        ...
                        <div className="card-body text-dark">
                            <div className="row">
                                <div className="col">
                                    <img src="https://vaya.in/recipes/wp-content/uploads/2018/02/Idli-and-Sambar-1.jpg"
                                         alt="" className="col rounded img-thumbnail"/>
                                </div>
                                <div className="col ">
                                    <div className="row">
                                        <blockquote className="blockquote mb-1">
                                            <h5 className="card-title text-danger my-1">Idly Sambhar & Vada</h5>
                                            <footer className="blockquote-footer">By <cite title="Source Title">Chef
                                                Anurag</cite></footer>
                                            <div className="my-1">
                                                ...
                                                <i className="material-icons" style={{color: "orange"}}>star</i>
                                                <i className="material-icons" style={{color: "orange"}}>star</i>
                                                <i className="material-icons" style={{color: "orange"}}>star_border</i>(53)
                                            </div>
                                        </blockquote>
                                    </div>
                                    <div className="row">
                            ...
                            <div className="row mx-2">
                                <p className="my-1">
                                    ...
                                    <b>Description: </b>Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor
                                    auctor.
                                    Duis mollis, est non commodo...<u><a href="#">view more</a></u>
                                </p>
                        ...
                        <div className="card-footer bg-transparent border-danger">
                            <div className="row">
                                <div className="col">
                                    <Button color="success" size="sm">Vegetarian</Button>
                                </div>
                                <div className="col">
                                    <Button color="danger" size="sm">Spicy: 3/5</Button>
                                </div>
                                <div className="col">
                                    <Button color="warning" size="sm">₹ 450</Button>
                                </div>
                                <div className="col">
